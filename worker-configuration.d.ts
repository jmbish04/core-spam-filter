/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d688474ea2b44cd9ba190692540b116e)
// Runtime types generated with workerd@1.20260424.1 2026-05-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/_worker");
		durableNamespaces: "EmailAnalyzerAgent";
	}
	interface Env {
		DB: D1Database;
		...
		AI: Ai;
		ASSETS: Fetcher;
		AI_GATEWAY_NAME: "core-spam-gateway";
		DEFAULT_MODEL: "@cf/meta/llama-3.3-70b-instruct-fp8-fast";
		EMBEDDING_MODEL: "@cf/baai/bge-large-en-v1.5";
		EmailAgent: DurableObjectNamespace<import("./src/_worker").EmailAnalyzerAgent>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_GATEWAY_NAME" | "DEFAULT_MODEL" | "EMBEDDING_MODEL">> {}
}
